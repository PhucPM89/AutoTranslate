...
function createTranslationEngine({ storage = null } = {}) {
  ...
  function buildContextualPrompt({
    ...
    return [
      ...
      "3. Chỉ chuyển âm Hán-Việt cho tên riêng, địa danh, môn phái, công pháp, cảnh giới và thuật ngữ thực sự.",
      "4. Các từ thường ngày, đại từ, động từ, liên từ phải dịch nghĩa thuần Việt; không chuyển âm máy móc kiểu Gia Gia, Ngã, Nhĩ, Khước, Giáo.",
      "5. Giữ nguyên cấu trúc các đoạn văn và hội thoại tương ứng với bản gốc.",
      "6. Chỉ trả về nội dung bản dịch tiếng Việt hoàn chỉnh, không kèm lời chào hay ghi chú.",
      "",
      glossarySection,
