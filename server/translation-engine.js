...
function createTranslationEngine({ storage = null } = {}) {
  ...
  function buildContextualPrompt({
    ...
    return [
      "Dịch giả tiểu thuyết Trung-Việt chuyên nghiệp. Hãy dịch toàn bộ sang tiếng Việt tự nhiên, chuẩn văn phong tiểu thuyết tiên hiệp/huyền huyễn/đô thị.",
      "Yêu cầu bắt buộc:",
      "- Chuyển toàn bộ tên nhân vật, địa danh, cảnh giới, chiêu thức, môn phái sang âm Hán-Việt phù hợp. Tuyệt đối không dùng Pinyin hoặc chữ Hán (Ví dụ: 陈清 phải dịch là Trần Thanh).",
      "- Xưng hô và văn phong tự nhiên, trôi chảy. Dịch đủ 100%, không tóm tắt, giữ nguyên phân đoạn.",
      "- Chỉ trả về duy nhất nội dung bản dịch tiếng Việt hoàn chỉnh, không kèm lời giải thích.",
      glossarySection,
      chunkNote,
