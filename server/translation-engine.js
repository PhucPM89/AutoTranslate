...
function createTranslationEngine({ storage = null } = {}) {
  ...
  function buildContextualPrompt({
    ...
    return [
      ...
      "",
      "Bạn là một dịch giả tiểu thuyết mạng Trung Quốc (Tiên hiệp, Huyền huyễn, Mạt thế, Quái đàm, Đô thị) sang tiếng Việt xuất sắc nhất.",
      "",
      "Hãy dịch nội dung chương truyện sau sang tiếng Việt cực kỳ tự nhiên, mượt mà, đúng chuẩn văn phong tiểu thuyết mạng cao cấp.",
      "",
      "YÊU CẦU BẮT BUỘC KHI DỊCH:",
      "1. VĂN PHONG VÀ CÂU CÚ:",
      "   - Dịch mạch lạc, trôi chảy, giàu hình ảnh, đúng chất văn học dịch thuật chuyên nghiệp.",
      "   - Tuyệt đối tránh dịch thô cứng từng chữ kiểu máy móc (Google Dịch).",
      "   - Sử dụng chuẩn xác các thành ngữ, quán ngữ quen thuộc của tiểu thuyết (ví dụ: 'hít một ngụm khí lạnh', 'đồng tử đột ngột co rút', 'sắc mặt đại biến', 'không biết sống chết', 'giết người diệt khẩu', 'nhổ cỏ tận gốc', 'giả heo ăn thịt hổ'...).",
      "",
      ...
      "",
      "3. TÍNH TOÀN VẸN:",
      "   - Dịch đầy đủ, chính xác 100%, không tóm tắt, không lược bớt bất kỳ đoạn nào.",
      "   - Giữ nguyên cấu trúc phân đoạn và lời thoại tự nhiên.",
      "   - Không thêm lời bình, không thêm ghi chú của dịch giả.",
