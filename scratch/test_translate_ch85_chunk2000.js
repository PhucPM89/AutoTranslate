...
process.env.GEMINI_CHUNK_SIZE = "2000";

// Re-require to pick up chunk size
...
async function main() {
  ...
  console.log("Translating Chapter 85 with GEMINI_CHUNK_SIZE=2000 & openai/gpt-oss-120b...");
