...
const PLAIN = {
  ...
  GOOGLE_DRIVE_STORAGE_FOLDER_ID: "1-TvHLKA7z_hyt90BdJpRBsjmCQGW3z8P",
  GITHUB_REPOSITORY: "PhucPM89/AutoTranslate"
};
const PLAIN_FROM_ENV = ["SUPABASE_URL", "SUPABASE_ANON_KEY", "GEMINI_MODEL", "GEMINI_FALLBACK_MODELS", "GEMINI_BASE_URL", "GOOGLE_DRIVE_STORAGE_FOLDER_ID"];
const SECRETS = [
  "R2_ACCOUNT_ID",
  "R2_ACCESS_KEY_ID",
